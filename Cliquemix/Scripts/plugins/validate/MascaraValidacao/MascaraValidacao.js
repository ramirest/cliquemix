...
function validacaoEmail(field) {
    ...
    if ((usuario.length >=1) &&
        ...
        (dominio.lastIndexOf(".") < dominio.length - 1)) {
            ...
            $("#msgemail_Invalido").attr("class", "alert alert-danger");
            $("#msgemail_Valido").attr("class", "");
            //Informa que o valor está incorreto
            document.getElementById("msgemail_Valido").innerHTML = "";
            document.getElementById("msgemail_Invalido").innerHTML =
                "<strong>Danger Alert:</strong> Something has gone wrong, let's fix it!";
            
            //Caso o E-mail for Válido...
            $("#msgemail_Invalido").attr("class", "");
            $("#msgemail_Valido").attr("class", "alert alert-success");

            //document.getElementById("msgemail_Valido").className("alert alert-success");
            //document.getElementById("msgemail_Invalido").className("");
            //document.getElementById("msgemail_Valido").innerHTML =
                    //"<strong>Success Alert:</strong> Good job! Everthing is correct and you're ready to go.";
        }
    else {
        //Caso o valor for Válido, altera o estado de exibição das divs
        $("#msgemail_Invalido").attr("class", "alert alert-danger");
